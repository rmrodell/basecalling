...
OUTPUT_DIR="$SCRATCH/20260407_dRNA_PUS7KO/basecalling"
...
echo "Submitting Stage 2: Merge Job (will wait for recovery jobs)..."
FINAL_JOB_ID=$(sbatch \
    --export=ALL,OUTPUT_DIR="$OUTPUT_DIR" \
    --parsable \
...
echo "--> Final merge job submitted with Job ID: $FINAL_JOB_ID"
echo ""
